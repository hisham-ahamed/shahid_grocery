...
import 'package:shahid_grocery_admin/src/Screens/Delivery_Report_Panel_Screen/components/output_heading.dart';
...
class _DeliveryReportPanelScreenState extends State<DeliveryReportPanelScreen> {
  ...
  String _dropDownTitle = "Select staff";
  ...
  void _initialize() async {
    _staffData = await Admin.getStaffDetails();
              ...
              children: [
                ...
                ListTile(
                  ...
                  title: _filterStaff
                      ? DropdownButton(
                          items: _items,
                          hint: Text(_dropDownTitle),
                          onChanged: (value) {
                            setState(() {
                              _selectedStaffName = value as String;
                            });
                          },
                        )
                      : null,
                ...
                ListTile(
                  title: Text('Staff Name', style: TextStyle(fontSize: 17.0)),
                  trailing: Checkbox(
                    value: _staffNameVisibility,
                    onChanged: (value) {
                      setState(() {
                        _staffNameVisibility = value;
                      });
                    },
                  ),
                ),
              ...
              child: Builder(builder: (BuildContext context) {
                if (_dataReceived) {
                                          ...
                                          child: ListView.builder(
                                              ...
                                              itemBuilder:
                                                ...
                                                return OutputCard(
                                                  ...
                                                  creditVisibility:
                                                      _creditVisibility,
                                                  valueCheck: _sortedData[index]
                                                      .checkValue,
                                                  deliveryData:
                                                      _sortedData[index],
                                                  checkOnChanged: (value) {
                                                    Admin.updateDeliveryCheck(
                                                        _sortedData[index],
                                                        value);
                                                    ...
                                                    _deliveryData
                                                        .forEach((element) {
                                                      if (element.id ==
                                                          _sortedData[index].id)
                                                        _deliveryData[_deliveryData
                                                                .indexOf(
                                                                    element)] =
                                                            DeliveryData
                                                                .onlyCheckValue(
                  ...
                  return FutureBuilder(
                      future: Admin.getDeliveryDetails(_dateSelected),
                      builder: (BuildContext context,
